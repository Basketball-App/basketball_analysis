...
class PlayerTracksDrawer:
    def __init__(self, team_1_color=(255,240, 250), team_2_color=(123, 20, 162 )):
        self.deafault_player_team = 1

        self.team_1_color = team_1_color
        self.team_2_color = team_2_color

    def draw(self, video_frames, player_tracks, player_assignment, ball_acquisition):
        output_video_frames = []
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for track_id, player in player_dict.items():
                ...
                team_id = player_assignment_for_frame.get(track_id, self.deafault_player_team)
